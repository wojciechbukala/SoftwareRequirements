...
![Use Cases Diagram](./Diagrams/UseCases.png)

## UC-01 - Make reservation
The main functionality of the system is the possibility to reserve a seat by a user for a specified event. Process is presented with the usage of activity diagram below.

![Activity Diagram - seat reservation](./Diagrams/SeatReservationActivityDiagram.png)

## UC-02 - Cancel reservation
Other key use case of the ystem is the possibility for a user to cancel reservation, presented at the activity diagram below:

![Activity Diagram - cancel reservation](./Diagrams/CancelReservationActivityDiagram.png)

## UC-03 - Add event
The key functionality of the administarot is the possibilibty to add an event, as presented below:

![Activity Diagram - create event](./Diagrams/CreateEventActivityDiagram.png)
