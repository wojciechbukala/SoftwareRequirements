...
![Domain Class Diagram](/Problem1%20-%20Copilot/Diagrams/P1_DCD.drawio.png)
...
![State machine](/Problem1%20-%20Copilot/Diagrams/P1_SM1.drawio.png)
...
![Flow chart](/Problem1%20-%20Copilot/Diagrams/P1_FC1.drawio.png)
...
![Flow chart](/Problem1%20-%20Copilot/Diagrams/P1_FC2.drawio.png)
...
**inputs**
- *sensor_log.csv*: timestamp (float), sensor_id (string), sensor_type (string), data_value (float), unit (string).
- *driver_events.csv*: timestamp (float), event_type (string), value (float).
...
**outputs**
- *state_log.csv*: timestamp (float), previous_state (string), current_state (string), trigger_event (string).
- *commands_log.csv*: timestamp (float), actuator_id (string), values (string or float).
- *feature_decision.csv*: timestamp (float), feature (string), decision (string or float).
